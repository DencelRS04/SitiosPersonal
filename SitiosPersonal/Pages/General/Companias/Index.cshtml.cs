...
namespace SitiosPersonal.Pages.General.Companias
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(CompaniaService repository, BitacoraService bitacoraService, PermisosService permisosRepository)
        {
        ...
        public CompaniasListaViewModel Lista { get; set; } = new CompaniasListaViewModel();
        ...
        public IActionResult OnGet(int pagina = 1)
        {
            ...
            Lista = new CompaniasListaViewModel
            {
                Pagina = pagina,
                CantidadPorPagina = cantidadPorPagina,
                TotalRegistros = _repository.Contar(),
                Companias = _repository.ListarPaginado(pagina, cantidadPorPagina)
            };

            _bitacoraService.RegistrarConsulta(idUsuario, "Compañías");
            return Page();
        }
        ...
        public IActionResult OnPostEliminar(int id)
        {
            ...
            _bitacoraService.RegistrarDelete(idUsuario, "Compañía",
                new { compania.id_compania, compania.codigo, compania.nombre });
            TempData["Exito"] = "Compañía eliminada correctamente.";
            return RedirectToPage("Index");
        }
